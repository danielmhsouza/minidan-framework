...
function updateThumbnail(dropZoneElement, file) {
    ...
    if (dropZoneElement.querySelector(".drop-zone .drop-zone__prompt")) {
        dropZoneElement.querySelector(".drop-zone. drop-zone__prompt").remove();
    }
...
let btn = document.querySelector('#vPass');

btn.addEventListener('click', function() {

    let input = document.querySelector('#pass');
    let input2 = document.querySelector('#cPass');
